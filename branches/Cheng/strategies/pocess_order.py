...
class OrderManager:
    def __init__(self, initial_capital, contract_size, margin_rate, max_position_ratio, 
                 fee_rate_t1, fee_rate_t0, slip_rate):
        self.open_orders = {}
        self.closed_orders = []
        self.order_id = 1
        ...
        self.fee_rate_t1 = fee_rate_t1
        self.fee_rate_t0 = fee_rate_t0
    ...
    def open_order(self, code: str, position: int, price: float, open_time: datetime, lot: int, slip: float) -> str: 
