/********************************************************************
    ...
    purpose:        数据定义C#
*********************************************************************/
#ifndef XTNETDATATYPE_2015_02_16_H
#define XTNETDATATYPE_2015_02_16_H
...
namespace NetApi
{
      // public enum class  defines


    public enum class EBrokerPriceType
    {
        ...
        BROKER_PRICE_PROP_YYSGYS = 76,                 //要约收购预售
        ...
        BROKER_PRICE_PROP_L5_FIRST_LIMITPX = 855,       //最优五档即时成交剩余转限价
    ...
    public enum class EEntrustStatus
    {
        ...
        ENTRUST_STATUS_UNKNOWN = 58,               //未知
    };


    public enum class EXTCompactType
    {
    ...
    public enum class EXTBrokerType
    {
        AT_FUTURE = 1,              //期货账号
        AT_STOCK = 2,               //股票账号
        AT_CREDIT = 3,              //信用账号
        ...
        AT_FICC_COMMODITY = 11,     //期货电子盘账号
        AT_FICC_INTEREST = 11,      //利率电子盘账号
    };


    public enum class EXTSubjectsStatus
    {
    ...
    public enum class EErrorType
    {
        ...
        XT_ERROR_CREATECOMMOND_PARAM = 300006,                    // 创建指令时，解析参数失败
        XT_ERROR_CREATECOMMOND_QUOTE = 300007,                    // 创建指令时，获取行情数据失败
        XT_ERROR_CREATECOMMOND_PRICE_TYPE = 300008,               // 创建指令时，获取有关报价类型的价格失败（如最新价等）
        XT_ERROR_ORDER_FLOW_CONTROL = 300009,                     // 下单超过流量控制
        XT_ERROR_ORDER_NOT_AUTHORIZE_STOCK_FUTURE = 300010,       // 股票期货业务没有授权
        XT_ERROR_ORDER_NOT_AUTHORIZE_STOCKOPTION = 300011,        // 股票期权业务没有授权
        XT_ERROR_ORDER_NOT_AUTHORIZE_CREDIT = 300012,             // 信用业务没有授权
        XT_ERROR_ORDER_NOT_AUTHORIZE_GOLD = 300013,               // 黄金业务没有授权
        XT_ERROR_ORDER_NOT_AUTHORIZE_HGT = 300014,                // 沪港通业务没有授权
        XT_ERROR_ORDER_NOT_AUTHORIZE_SGT = 300015,                // 深港通业务没有授权
        XT_ERROR_QUERYDATA_FLOW_CONTROL = 300016,                 // 请求超过流量控制
        XT_ERROR_LOGIN_MAC_NOT_MATCH = 300017,                    // mac不匹配
        XT_ERROR_LOGIN_MAC_NOT_AUTHORIZE = 300018,                // mac未授权
        XT_ERROR_SUBSCRIBE_QUOTE = 300019,                        // 订阅行情时报错
        XT_ERROR_CREATECOMMOND_TRANSUNABLE = 300020,              // 创建指令时，合约不可交易
    };


    public enum class EHedgeFlagType
    {
    ...
    public enum class EFutureTradeType
    {
    ...
    public enum class EXTCompactStatus
    {
    ...
    public enum class EVolumeType
    {
        ...
        VOLUME_FIX = 10,  
        VOLUME_LEFT = 11,  
        VOLUME_POSITION = 12,   //持仓数量
        _C_VOLUME_COUNT = 13,  
    };


    public enum class EBrokerLoginStatus
    {
        BROKER_LOGIN_STATUS_INALID = -1,  
        BROKER_LOGIN_STATUS_OK = 0,           //可用，初始化完成
        BROKER_LOGIN_STATUS_WAITING_LOGIN = 1,    //连接中
        BROKER_LOGIN_STATUS_LOGINING = 2,         //登录中
        BROKER_LOGIN_STATUS_FAIL = 3,             //失败
        BROKER_LOGIN_STATUS_INITING = 4,          //在初始化中
        BROKER_LOGIN_STATUS_CORRECTING = 5,       //数据刷新校正中
        BROKER_LOGIN_STATUS_CLOSED = 6,           //收盘后
    };


    public enum class EOperationType
    {
        OPT_INVALID = -1,  
        OPT_OPEN_LONG = 0,                // 开多 0
        OPT_CLOSE_LONG_HISTORY = 1,           //平昨多 1
        OPT_CLOSE_LONG_TODAY = 2,             //平今多 2
        OPT_OPEN_SHORT = 3,                   //开空 3
        OPT_CLOSE_SHORT_HISTORY = 4,          // 平昨空 4
        OPT_CLOSE_SHORT_TODAY = 5,            // 平今空 5
        OPT_CLOSE_LONG_TODAY_FIRST = 6,       // 平多，优先平今  6
        OPT_CLOSE_LONG_HISTORY_FIRST = 7,     // 平多，优先平昨 7
        OPT_CLOSE_SHORT_TODAY_FIRST = 8,      // 平空，优先平今 8
        OPT_CLOSE_SHORT_HISTORY_FIRST = 9,    // 平空，优先平昨 9
    ...
    public enum class EEntrustTypes
    {
    ...
    public enum class EOffsetFlagType
    {
    ...
    public enum class EEntrustSubmitStatus
    {
    ...
    public enum class EPriceType
    {
        ...
        PRTP_COMPETE = 14,      //对手价
        //期货市价
        PRTP_MARKET_BEST = 18,                  //市价_最优价 郑商所
        PRTP_MARKET_CANCEL,                     //市价_即成剩撤 大商所
        PRTP_MARKET_CANCEL_ALL,                 //市价_全额成交或撤 大商所
        PRTP_MARKET_CANCEL_1,                   //市价_最优1档即成剩撤 中金所
        PRTP_MARKET_CANCEL_5,                   //市价_最优5档即成剩撤 中金所 上期所
        PRTP_MARKET_CONVERT_1,                  //市价_最优1档即成剩转 中金所
        PRTP_MARKET_CONVERT_5,                  //市价_最优5档即成剩转 中金所 上期所
    ...
    public enum class EXtOverFreqOrderMode
    {
        OFQ_FORBID = 0,   // 禁止
        OFQ_QUEUE = 1,    //队列
    };
    ...
    public enum class EOrderCommandStatus
    {
    ...
    public enum class EXtSuspendedType
    {
        XT_NO_SUSPENDED = 0, //不停牌
        XT_SUSPENDED = 1, //停牌
    };

    public enum class ETimeCondition
    {
    ...
    public enum class EVolumeCondition
    {
    ...
    public enum class ETaskFlowOperation
    {
        TFO_PAUSE = 5, //暂停
        TFO_RESUME = 6, //恢复
    };

    public enum class EXTCompactBrushSource
    {
    ...
    public enum class EOpTriggerType
    {
        OTT_NONE = 0,  //不使用触价
        OTT_UP = 1,  //向上触价
        OTT_DOWN = 2,  //向下触价
    ...
    public enum class EXTExchangeStatus
    {
        EXCHANGE_STATUS_INVALID = 0,  //非法值
        EXCHANGE_STATUS_IN_BEFORE_TRADING = 48,  //开盘前
        EXCHANGE_STATUS_NOTRADING = 49,  //非交易
        EXCHANGE_STATUS_IN_CONTINOUS = 50,  //连续交易
    ...
    public enum class EXtMaxMarginSideAlgorithmType
    {
        XT_FTDC_MMSA_NO = 48,  //不使用大额单边保证金算法
        XT_FTDC_MMSA_YES = 49,  //使用大额单边保证金算法
    };

    public enum class EAlgoPriceType
    {
        EALGO_PRT_MARKET = 0,  //市价
        EALGO_PRT_FIX = 1,  //限价
    };

    public enum class ETransDirection
    {
    ...
    public enum class EStopTradeForOwnHiLow
    {
        STOPTRADE_NONE = 0,             //无
    ...
    ///< 算法下单方式
    public enum class EOrderStrategyType
    {
    ...
    public enum class ETransTypeCreditFlag
    {
    ...
    public enum class EProductClass
    {
    ...
    public enum class EAbroadDurationType
    {
    ...
    public enum class EXtExDivdendType
    {
    ...
    public enum class EMainFlag
    {
        MAIN_FLAG_VICE = 48,      //副账户
        MAIN_FLAG_MAIN,       //主账户
    };

    public enum class EXTCommandDateLimit
    {
