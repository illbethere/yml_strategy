#ifndef API_CALL_BACK_DEMO3_H_
#define API_CALL_BACK_DEMO3_H_
...
namespace demo3
{
    ...
    */
    ...
    public:
        ...
        void testStockOrdinaryOrder(const std::string& accountId);

        // 期货普通单测试
        // @param   accountId 资金账号
        void testFutureOrdinaryOrder(const string& accountId);
