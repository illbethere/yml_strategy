...
namespace xti
{
    ...
    */
    ...
    public:
        ...
        */
        virtual xti::CAccountDetail reqAccountDetailSync(const char* accountID, XtError& error, const char* accountKey = "") = 0;
        ...
        * @param [in] accountKey 账号Key，用于区分不同类型的账号ID相同的账号
        */
        virtual void reqFuturePositionStatics(const char* accountID, int nRequestId, const char* accountKey = "") = 0;
        ...
        * @param [in] accountKey 账号Key，用于区分不同类型的账号ID相同的账号
        */
        virtual std::vector<xti::CFuturePositionStatics> reqFuturePositionStaticsSync(const char* accountID, XtError& error, const char* accountKey = "") = 0;
        ...
        * @param [in] error 错误信息，用于接收同步请求时的错误信息
        */
        virtual xti::CPriceData reqPriceDataSync(const char* exchangeId, const char* instrumentId, XtError& error) = 0;

        /**
        * @brief 按市场请求行情数据信息 已废弃，后续不在维护，改用reqInstrumentInfoByMarket--20240522
        * @note 调用此函数后，回调 onReqCInstrumentDetail
        * @param [in] exchangeId 市场，取值参考MarketType.h
        * @param [in] nRequestId 客户自己维护的请求顺序ID
        * @param [in] tradable 是否只查询可交易合约，默认0,否， 1,是
        */
        ...
        */
        ...
        /**
        * @brief 批量退订推送数据
        * @note 调用此函数后，回调 onUnSubscribeMetes
        * @param[in] data 订阅参数
        * @param[in] nRequestId 客户自己维护的请求顺序ID
        */
        ...
        */
        ...
        /**
        * @brief 华创算法下单，支持股票，期货，个股期权，期货期权，沪港通，深港通
        * @note 华创算法下单，回调 onOrder
        * @param [in] orderInfo 华创算法交易请求参数
        * @param [in] nRequestId 客户自己维护的请求顺序ID
        * @param [in] accountKey 账号Key，用于区分不同类型的账号ID相同的账号
        */
        virtual void order(const CHuaChuangAlgorithmOrder* orderInfo, int nRequestId, const char* accountKey = "") = 0;

        /**
        * @brief 组合华创算法单下单，支持股票，期货，个股期权，期货期权，沪港通，深港通
        * @note 华创算法下单，回调 onOrder
        * @param [in] orderInfo 组合华创算法单请求参数
        * @param [in] error 错误信息，用于接收同步请求时的错误信息
        * @param [in] accountKey 账号Key，用于区分不同类型的账号ID相同的账号        */

        virtual void order(const CHuaChuangAlgoGroupOrder* orderInfo, int nRequestId, const char* accountKey = "") = 0;
        ...
        * @param [in] nRequestId 客户自己维护的请求顺序ID
        */
        virtual void check(const COrdinaryOrder* orderInfo ,int nRequestId, const char* accountKey = "") = 0;
        ...
        */
        ...
        virtual xti::CCheckData checkSync(const COrdinaryOrder* orderInfo, XtError& error, const char* accountKey = "") = 0;
        /**
        * @brief 算法单风险试算
        ...
        * @param [in] nRequestId 客户自己维护的请求顺序ID
        */
        virtual void check(const CGroupOrder* orderInfo ,int nRequestId, const char* accountKey = "") = 0;
        ...
        */
        ...
        virtual xti::CCheckData checkSync(const CGroupOrder* orderInfo, XtError& error, const char* accountKey = "") = 0;
        ...
        * @param [in] accountKey 账号Key，用于区分不同类型的账号ID相同的账号
        */
        virtual void refreshStkUnCloseCompacts(const char* accountID, int nRequestId, const char* accountKey = "") = 0;
        ...
        * @param [in] accountKey 账号Key，用于区分不同类型的账号ID相同的账号
        */
        virtual void refreshStkClosedCompacts(const char* accountID, int nRequestId, const char* accountKey = "") = 0;
        ...
        */
        ...
        /**
        * @brief 根据委托号请求账号委托明细信息
        * @note 调用此函数后，回调 onReqOrderDetailBySysID
        * @param [in] accountID 账号ID
        * @param [in] nRequestId 客户自己维护的请求顺序ID
        ...
        * @param [in] accountKey 账号Key，用于区分不同类型的账号ID相同的账号
        */
        virtual void reqOrderDetailBySysID(const char* accountID, int nRequestId, const char* orderSyeId, const char* exchangeId, const char* accountKey = "") = 0;

        /**
        * @brief 根据委托号请求账号委托明细信息
        * @note 调用此函数后，返回COrderDetail
        * @param [in] accountID 账号ID
        * @param [in] error 错误信息，用于接收同步请求时的错误信息
        * @param [in] orderSyeId 下单的委托号
        * @param [in] exchangeId 委托所属市场
        * @param [in] accountKey 账号Key，用于区分不同类型的账号ID相同的账号
        */
        virtual xti::COrderDetail reqOrderDetailBySysIDSync(const char* accountID, XtError& error, const char* orderSyeId, const char* exchangeId, const char* accountKey = "") = 0;
        ...
        */
        ...
        /**
        * @brief 请求账号结算单信息
        * @note 调用此函数后，返回std::vector<xti::CDeliveryDetail>
        * @param [in] accountID 账号ID
        * @param [in] startDate 查询开始时间
        * @param [in] endDate 查询结束时间
        * @param [in] error 错误信息，用于接收同步请求时的错误信息
        * @param [in] accountKey 账号Key，用于区分不同类型的账号ID相同的账号
        */
        virtual std::vector<xti::CDeliveryDetail> reqDeliveryDetailSync(const char* accountID, const char* startDate, const char* endDate, XtError& error, const char* accountKey = "") = 0;
        ...
        * @param [in] tradable 是否只查询可交易合约，默认0,否， 1,是
        */
        virtual void reqInstrumentInfoByMarket(const char* exchangeId, int nRequestId, int tradable = 0) = 0;
        ...
        * @param [in] tradable 是否只查询可交易合约，默认0,否， 1,是
        */
        virtual std::vector<xti::CInstrumentInfo> reqInstrumentInfoByMarketSync(const char* exchangeId, XtError& error, int tradable = 0) = 0;
        ...
        */
        ...
        /**
        * @brief 请求资金账号所有下单指令
        * @note 调用此函数后，回调 onReqCommandsInfoWithAccKey
        * @param [in] accountKey 账号Key，用于区分不同类型的账号ID相同的账号
        * @param [in] nRequestId 客户自己维护的请求顺序ID
        */
        virtual void reqCommandsInfoWithAccKey(int nRequestId, const char* accountKey = "") = 0;

        /**
        * @brief 同步请求资金账号所有下单指令
        * @param [in] error 错误信息，用于接收同步请求时的错误信息
        * @param [in] accountKey 账号Key，用于区分不同类型的账号ID相同的账号
        */
        virtual std::vector<xti::COrderInfo> reqCommandsInfoWithAccKeySync(XtError& error, const char* accountKey = "") = 0;
        ...
        * @param [in] accountKey 账号Key，用于区分不同类型的账号ID相同的账号
        */
        virtual std::vector<xti::CExchangeStatus> reqExchangeStatusSync(const char* accountID, XtError& error, const char* accountKey = "") = 0;
        ...
        */
        ...
        /**
        * @brief 查询ETF申赎清单
        * @note 调用此函数后，回调onReqEtfDetails
        * @param [in] nRequestId  请求编号
        */
        virtual void reqEtfDetails(int nRequestId) = 0;

        /**
        * @brief 查询ETF申赎清单 同步接口
        * @note 调用此函数后，回调CETFPCFDetail组成的vector
        * @param [in] error 错误信息，用于接收同步请求时的错误信息
        */
        virtual std::vector<xti::CETFPCFDetail> reqEtfDetailsSync(XtError& error) = 0;

        /**
        * @brief 查询ETF成分股信息
        * @note 调用此函数后，回调onReqETFComponentStockInfo
        * @param [in] exchangeId  市场代码
        * @param [in] instrumentId  合约代码
        * @param [in] nRequestId  请求编号
        */
        virtual void reqETFComponentStockInfo(const char* exchangeId, const char* instrumentId, int nRequestId) = 0;

        /**
        * @brief 查询ETF成分股信息 同步接口
        * @note 调用此函数后，回调CETFComponentStockInfo组成的vector
        * @param [in] error 错误信息，用于接收同步请求时的错误信息
        * @param [in] exchangeId  市场代码
        * @param [in] instrumentId  合约代码
        */
        virtual std::vector<xti::CETFComponentStockInfo> reqETFComponentStockInfoSync(const char* exchangeId, const char* instrumentId, XtError& error) = 0;
        
        /**
        * @brief 查询用户设置 
        * @note 调用此函数后，回调onReqUserConfig
        * @param [in] metaID 数据ID
        * @param [in] startDate  起始日期
        * @param [in] endDate  终止日期
        * @param [in] strTag  附加信息
        * @param [in] nRequestId  请求编号
        */
        virtual void reqUserConfig(int metaID, const char* startDate, const char* endDate, const char* strTag, int nRequestId) = 0;
        
        /**
        *@brief 查询用户设置 同步接口
        * @note 调用此函数后，回调CUserConfig组成的vector
        * @param [in] metaID 数据ID
        * @param [in] startDate  起始日期
        * @param [in] endDate  终止日期
        * @param [in] strTag  附加信息
        * @param [in] error 错误信息，用于接收同步请求时的错误信息
        */
        virtual std::vector<xti::CUserConfig> reqUserConfigSync(int metaID, const char* startDate, const char* endDate, const char* strTag, XtError& error) = 0;

        /**
        * @brief 查询用户资金流水信息
        * @note 调用此函数后，回调onReqFundFlow
        * @param [in] accountID  资金账号
        * @param [in] startDate  起始日期
        * @param [in] endDate  终止日期
        * @param [in] nRequestId  请求编号
        * @param [in] accountKey 账号Key，用于区分不同类型的账号ID相同的账号
        */
        virtual void reqFundFlow(const char* accountID, const char* startDate, const char* endDate, int nRequestId, const char* accountKey = "") = 0;

        /**
        *@brief 查询用户资金流水信息 同步接口
        * @note 调用此函数后，回调CFundFlow组成的vector
        * @param [in] accountID  资金账号
        * @param [in] startDate  起始日期
        * @param [in] endDate  终止日期
        * @param [in] error 错误信息，用于接收同步请求时的错误信息
        * @param [in] accountKey 账号Key，用于区分不同类型的账号ID相同的账号
        */
        virtual std::vector<xti::CFundFlow> reqFundFlowSync(const char* accountID, const char* startDate, const char* endDate, XtError& error, const char* accountKey = "") = 0;

        /**
        * @brief 更新条件单指令 同步接口，支持股票，期货，个股期权，期货期权，沪港通，深港通
        * @param [in] orderId 指令编号
        * @param [in] m_strOtherParam 条件单修改条件参数
        * @param [in] strKey 操作Key，
        * @param [in] error 错误信息，用于接收同步请求时的错误信息
        */

        virtual void updateCommandConditionSync(int orderId, const char* strOtherParam, const char* strKey, XtError& error) = 0;

        /**
        * @brief 更新条件单指令，支持股票，期货，个股期权，期货期权，沪港通，深港通
        * @note 更新条件单指令，回调 onUpdateCommandCondition
        * @param [in] orderId 指令编号
        * @param [in] m_strOtherParam 条件单修改条件参数
        * @param [in] strKey 操作Key
        * @param [in] nRequestId 客户自己维护的请求顺序ID
        */
        virtual void updateCommandCondition(int orderId, const char* strOtherParam, const char* strKey, int nRequestId) = 0;
    ...
    */
    ...
    public:
       ...
       * @param [out] nRequestId 客户自己维护的请求顺序ID
       * @param [out] accountKey 账户key
       * @param [out] data 期货账号持仓统计数据，一次最大返回设置返回条数，数据超过设置数量多次返回
        * @param [out] isLast 请求数据可能超过单次最大返回条数，需要多次回调该函数，标记是否是一次请求的最后一次回调
       * @param [out] error 错误信息
       * @attention 当error返回报错时，data内容不可用
       */
        virtual void onReqFuturePositionStatics(const char* accountID, int nRequestId, const char* accountKey, std::vector<CFuturePositionStatics>* data, bool isLast, const XtError& error) {}
       ...
       */
        ...
        * @attention 当error返回报错时，data内容不可用
        */
        virtual void onReqOrderDetailBySysID(const char* accountID, int nRequestId, const char* accountKey, const char* orderSyeId, const char* exchangeId, const COrderDetail* data, const XtError& error) {}
       ...
       */
        ...
        * @attention 当error返回报错时，data内容不可用
        */
        virtual void onReqCommandsInfoWithAccKey(int nRequestId, std::vector<COrderInfo>* data, bool isLast, const XtError& error) {}
        ...
        */
        ...
        /**
        * @brief 请求ETF申赎清单的回调函数
        * @param [out] nRequestId 客户自己维护的请求顺序ID
        * @param [out] data ETF数据
        * @param [out] error 错误信息
        * @attention 当error返回报错时，data内容不可用
        */
        virtual void onReqEtfDetails( int nRequestId, std::vector<CETFPCFDetail>* data, const XtError& error) {}

        /**
        * @brief 请求ETF成分股信息的回调函数
        * @param [out] nRequestId 客户自己维护的请求顺序ID
        * @param [out] data ETF成分股数据
        * @param [out] error 错误信息
        * @attention 当error返回报错时，data内容不可用
        */
        virtual void onReqETFComponentStockInfo(int nRequestId, std::vector<CETFComponentStockInfo>* data, const XtError& error) {}

        /**
        * @brief 请求用户设置数据的回调函数
        * @param [out] nRequestId 客户自己维护的请求顺序ID
        * @param [out] data 用户设置数据
        * @param [out] error 错误信息
        * @attention 当error返回报错时，data内容不可用
        */
        virtual void onReqUserConfig(int nRequestId, std::vector<CUserConfig>* data, const XtError& error) {}
        ...
        * @param [out] nRequestId 客户自己维护的请求顺序ID
        * @param [out] accountKey 账号key
        * @param [out] data 用户资金流水数据
        * @param [out] error 错误信息
        * @attention 当error返回报错时，data内容不可用
        */
        virtual void onReqFundFlow(const char* accountID, int nRequestId, const char* accountKey, std::vector<CFundFlow>* data, const XtError& error) {}

        /**
        * @brief 主推市场和交易日
        * @param [out] market 交易市场
        * @param [out] tradeDay 交易日
        */
        virtual void onRtnMarketAndTradeDay(const char* market, const char* tradeDay) {}

        /**
        * @brief 请求用户资金流水的回调函数
        * @param [out] orderId 指令编号
        * @param [out] nRequestId 客户自己维护的请求顺序ID
        * @param [out] strKey 更新操作key
        * @param [out] error 错误信息
        * @attention 当error返回报错时，data内容不可用
        */
        virtual void onUpdateCommandCondition(int orderId, int nRequestId, const char* strKey, const XtError& error) {}
