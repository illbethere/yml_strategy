...
namespace xti
{
    ...
    enum XT_API_EXPORT EXTBrokerType
    {
        ...
        AT_DIGICOIN = 17,           ///<数字货币账号
        AT_OUTTER_FUTURE = 1001,    ///<期货外盘
        AT_IB = 1002,               ///<IB
        AT_NS_TRUSTBANK = 15001,    ///<场外托管  ///< 废弃不用
        AT_INTERBANK = 15002,       ///<银行间账号
        AT_BANK = 15003,            ///<银行账号
        AT_OTC = 15005,             ///<场外账号
        AT_CS_BUS = 15006,          ///<场外综合业务账号
    };
    ...
    enum XT_API_EXPORT EPriceType 
    {
        ...
        PRTP_MARKET_SZ_INSTBUSI_RESTCANCEL,     ///< 即时成交剩余撤销委托    //中金所FAK
        PRTP_MARKET_SZ_CONVERT_5_CANCEL,        ///< 最优五档即时成交剩余撤销委托
        PRTP_MARKET_SZ_FULL_REAL_CANCEL,        ///< 全额成交或撤销委托      //中金所FOK
    ...
    enum XT_API_EXPORT EBrokerPriceType
    {
        ...
        BROKER_PRICE_PROP_MARKET = 130,         ///< 市价_涨跌停价
    ...
    enum XT_API_EXPORT EOperationType
    {
        ...
        OPT_N3B_LIMIT_PRICE_BUY = 48, //全国股转-挂牌公司交易-做市转让-限价买入
    ...
    enum XT_API_EXPORT EBrokerLoginStatus
    {
        ...
        BROKER_LOGIN_STATUS_CTP_OVER_LIMIT = 10, ///< CTP连接超限
    };
    ...
    /// 现金替代标识
    enum XT_API_EXPORT EReplaceFlag
    {
    ...
    enum XT_API_EXPORT EXTCommandDateLimit
    {
    ...
    enum XT_API_EXPORT PortfolioPositionType
    {
        XT_PORTFOLIO_POSITION_COMMON = 0,
    ...
    enum XT_API_EXPORT PortfolioDealType
    {
        XT_PORTFOLIO_ADJUST_COMMON = 0,                // 普通调整
        XT_PORTFOLIO_ADJUST_RESTRICTED_STOCK = 1,      // 限售股
        XT_PORTFOLIO_ADJUST_SUB_FUND = 2,              // 子基金
        XT_PORTFOLIO_ADJUST_INCOME = 3,                // 特殊成交类型, 收入
        XT_PORTFOLIO_ADJUST_COST = 4,                  // 特殊成交类型, 费用
        XT_PORTFOLIO_ADJUST_BONDS_CONVERT = 5,         // 特殊成交类型, 可转债转股
        XT_PORTFOLIO_ADJUST_BONDS_SELLBACK = 6,        // 特殊成交类型, 可转债回售
        XT_PORTFOLIO_ADJUST_STOCK_ALLOTMENT = 7,       // 特殊成交类型, 股票配股
        XT_PORTFOLIO_ADJUST_STOCK_SUBSCRIPTION = 8,    // 特殊成交类型, 新股申购
        XT_PORTFOLIO_ADJUST_DIVIDEND_STOCK = 9,        // 特殊成交类型, 除权送股
        XT_PORTFOLIO_ADJUST_DIVIDEND_CASH = 10,        // 特殊成交类型, 除权分红
    };
    enum XT_API_EXPORT OrderPriceType
    {
        XT_OPF_GFD = 0,      // 当日有效
