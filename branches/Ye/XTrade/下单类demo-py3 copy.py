...
class xtTraderApiClient:
    ...
    def future_order(self, account_id:str, account_key:str, price: float, super_price_rate:float, 
                     volume:int, market:str, code:str, price_type: EPriceType = EPriceType.PRTP_FIX,
                    operation_type: EOperationType = EOperationType.OPT_OPEN_LONG, remark: str = ""):
...
if __name__ == '__main__':
    ...
    apiclient = xtTraderApiClient(server_addr, username, password)
    apiclient.init()
    apiclient.future_order(accountID, accountKey, 50, 0.2, 1, "DCE", "jd2508-C-3700", EPriceType.PRTP_FIX, EOperationType.OPT_OPEN_SHORT)
    apiclient.join() # 阻塞主进程
