    ...
    def setup_data(self):
        ...
        try:
            ...
            dict_data = self.get_market_data(
                self.contract_deal, "1d", "20250407", today, 22
            )
            dict_data_all = self.get_market_data(
                self.main_contract, "1d", "20250407", today, 22
            )

            for contract in self.contract_deal:
                if contract in dict_data and not dict_data[contract].empty:
                    close_min_18 = dict_data[contract]["close"].tail(18).min()
                    close_max_18 = dict_data[contract]["close"].tail(18).max()
                    close_min_19 = dict_data[contract]["close"].tail(19).min()
                    close_max_19 = dict_data[contract]["close"].tail(19).max()
                    close_min_20 = dict_data[contract]["close"].tail(20).min()
                    close_max_20 = dict_data[contract]["close"].tail(20).max()
                    close_min_21 = dict_data[contract]["close"].tail(21).min()
                    close_max_21 = dict_data[contract]["close"].tail(21).max()
                    close_min_22 = dict_data[contract]["close"].tail(22).min()
                    close_max_22 = dict_data[contract]["close"].tail(22).max()
                    self.dict_history[contract] = {
                        "close_min_18": close_min_18,
                        "close_max_18": close_max_18,
                        "close_min_19": close_min_19,
                        "close_max_19": close_max_19,
                        "close_min_20": close_min_20,
                        "close_max_20": close_max_20,
                        "close_min_21": close_min_21,
                        "close_max_21": close_max_21,
                        "close_min_22": close_min_22,
                        "close_max_22": close_max_22,
                    }
            ...
            for contract in self.main_contract:
                close_min_18 = dict_data_all[contract]["close"].tail(18).min()
                close_max_18 = dict_data_all[contract]["close"].tail(18).max()
                close_min_19 = dict_data_all[contract]["close"].tail(19).min()
                close_max_19 = dict_data_all[contract]["close"].tail(19).max()
                close_min_20 = dict_data_all[contract]["close"].tail(20).min()
                close_max_20 = dict_data_all[contract]["close"].tail(20).max()
                close_min_21 = dict_data_all[contract]["close"].tail(21).min()
                close_max_21 = dict_data_all[contract]["close"].tail(21).max()
                close_min_22 = dict_data_all[contract]["close"].tail(22).min()
                close_max_22 = dict_data_all[contract]["close"].tail(22).max()
            ...
            columns_1m = ["signal", "count", "strike", "min", "max", "price"]
            ...
            self.df_results["pos_18"] = [
                tick_stats[c]["pos_18"] for c in self.contract_deal
            ]
            self.df_results["neg_18"] = [
                tick_stats[c]["neg_18"] for c in self.contract_deal
            ]
            self.df_results["pos_19"] = [
                tick_stats[c]["pos_19"] for c in self.contract_deal
            ]
            self.df_results["neg_19"] = [
                tick_stats[c]["neg_19"] for c in self.contract_deal
            ]
            self.df_results["pos_20"] = [
                tick_stats[c]["pos_20"] for c in self.contract_deal
            ]
            self.df_results["neg_20"] = [
                tick_stats[c]["neg_20"] for c in self.contract_deal
            ]
            self.df_results["pos_21"] = [
                tick_stats[c]["pos_21"] for c in self.contract_deal
            ]
            self.df_results["neg_21"] = [
                tick_stats[c]["neg_21"] for c in self.contract_deal
            ]
            self.df_results["pos_22"] = [
                tick_stats[c]["pos_22"] for c in self.contract_deal
            ]
            self.df_results["neg_22"] = [
                tick_stats[c]["neg_22"] for c in self.contract_deal
            ]
            ...
            self.df_results_all["pos_18"] = [
                min1_stats[c]["pos_18"] for c in self.main_contract
            ]
            self.df_results_all["neg_18"] = [
                min1_stats[c]["neg_18"] for c in self.main_contract
            ]
            self.df_results_all["pos_19"] = [
                min1_stats[c]["pos_19"] for c in self.main_contract
            ]
            self.df_results_all["neg_19"] = [
                min1_stats[c]["neg_19"] for c in self.main_contract
            ]
            self.df_results_all["pos_20"] = [
                min1_stats[c]["pos_20"] for c in self.main_contract
            ]
            self.df_results_all["neg_20"] = [
                min1_stats[c]["neg_20"] for c in self.main_contract
            ]
            self.df_results_all["pos_21"] = [
                min1_stats[c]["pos_21"] for c in self.main_contract
            ]
            self.df_results_all["neg_21"] = [
                min1_stats[c]["neg_21"] for c in self.main_contract
            ]
            self.df_results_all["pos_22"] = [
                min1_stats[c]["pos_22"] for c in self.main_contract
            ]
            self.df_results_all["neg_22"] = [
                min1_stats[c]["neg_22"] for c in self.main_contract
            ]
    ...
    def init_signal_stats(self, contracts, dict_history, start, today):
        ...
        try:
            ...
            for contract in contracts:
                close_min_18 = dict_history[contract]["close_min_18"]
                close_max_18 = dict_history[contract]["close_max_18"]
                close_min_19 = dict_history[contract]["close_min_19"]
                close_max_19 = dict_history[contract]["close_max_19"]
                close_min_20 = dict_history[contract]["close_min_20"]
                close_max_20 = dict_history[contract]["close_max_20"]
                close_min_21 = dict_history[contract]["close_min_21"]
                close_max_21 = dict_history[contract]["close_max_21"]
                close_min_22 = dict_history[contract]["close_min_22"]
                close_max_22 = dict_history[contract]["close_max_22"]
                closes = hist_data[contract]["close"]
                pos_18 = (closes > close_max_18).sum()
                neg_18 = (closes < close_min_18).sum()
                pos_19 = (closes > close_max_19).sum()
                neg_19 = (closes < close_min_19).sum()
                pos_20 = (closes > close_max_20).sum()
                neg_20 = (closes < close_min_20).sum()
                pos_21 = (closes > close_max_21).sum()
                neg_21 = (closes < close_min_21).sum()
                pos_22 = (closes > close_max_22).sum()
                neg_22 = (closes < close_min_22).sum()
                stats[contract] = {
                    "pos_18": int(pos_18),
                    "neg_18": int(neg_18),
                    "pos_19": int(pos_19),
                ...
                self.log_message(f"初始化 {contract}")
        except Exception as e:
            self.log_message(f"初始化信号统计失败: {str(e)}")
            # 如果失败，使用默认值
            for contract in contracts:
                stats[contract] = {"pos_18": 0, "neg_18": 0}
        return stats
    ...
    async def update_data(self):
        ...
        try:
                ...
                for contract in self.main_contract:
                    ...
                    if time_check:
                        ...
                        for i in range(22, 17, -1):
                            if (
                                close_now
                                < self.dict_history_all[contract][f"close_min_{i}"]
                            ):
                                self.df_results_all.at[contract, f"neg_{i}"] += 1

                            elif (
                                close_now
                                > self.dict_history_all[contract][f"close_max_{i}"]
                            ):
                                self.df_results_all.at[contract, f"pos_{i}"] += 1

                            if self.df_results_all.at[contract, f"neg_{i}"] >= 10:
                                signal += 1
                            elif self.df_results_all.at[contract, f"pos_{i}"] >= 10:
                                signal -= 1

                    if (
                        self.df_results_all.at[contract, "signal"] == 0
                        and self.df_results_all.at[contract, "pos_18"] > 1
                    ):
                        ...
                        self.df_results_all.at[contract, "signal"] == 0
                        and self.df_results_all.at[contract, "neg_18"] > 1
                    ):
                        self.df_results_all.at[contract, "strike"] = close_now * (
                            1 + self.n
                        )

                    if self.df_results_all.at[contract, "signal"] > 0:
                        self.log_message(
                            f"Sell Put信号: {contract} at price {self.df_results_all.at[contract, 'strike']:.2f}"
                        )
                    elif self.df_results_all.at[contract, "signal"] < 0:
                        self.log_message(
            ...
            for contract in self.contract_deal:
                ...
                if close_now > close_max and time_check:
                    count_pos += 1
                    self.df_results.at[contract, "pos"] = count_pos
                elif close_now < close_min and time_check:
                    count_neg += 1
